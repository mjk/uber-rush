...
class Delivery extends EventEmitter {
  constructor(options) {
    ...
    if (options.courier) this.setCourier(options.courier);
...
Delivery.get = function(deliveryId) {
  return API.get(`deliveries/${deliveryId}`).then(function(delivery) {
