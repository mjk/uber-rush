...
Delivery.prototype.simulate = function(delay) {
    ...
    var self = this;
    var i = 0;
    if (isNaN(delay) || delay == 0) delay = SIMULATION_UPDATE_INTERVAL_SECONDS*1000;
    ...
    console.log('simulating delivery with a delay of ' + Math.ceiling(delay/1000.00) + 's between stages');
};
